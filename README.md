...
>
>Он используется классами, реализующими интерфейс *List*, то есть классами *LinkedList, ArrayList* и др.
>
...
>```
>
>[ListIteratorDemo - Пример использования ListIterator](https://github.com/aykononov/JavaCollections/blob/master/src/InterfaceIterator/ListIteratorDemo.java "Посмотреть пример Java")
</details>
