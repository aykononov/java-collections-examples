...
Получим первый элемент: Elena

Получим последний элемент: Mariya

Добавим элемент Petr, результат: true

Поднабор: [Elena, Ivan, Mariya]

Элемент Mariya выше Ivan

Элемент Elena ниже Ivan

Возвращаем набор в обратном порядке: [Petr, Mariya, Ivan, Elena]

Возвращаем набор в котором все элементы меньше Ivan: [Elena]

Возвращаем набор в котором все элементы больше (включая) Ivan: [Ivan, Mariya, Petr]
